<template>
    <div class="row mb-3">
        <div class="col-6">
            ...
            <input type="number" id="q2_driver_count" class="form-control" v-model="formatDetails.q2_driver_count"
                   required>
        </div>

        <div class="col-6">
            <label for="q3_driver_count" class="form-label">Q3 driver count</label>
            <input type="number" id="q3_driver_count" class="form-control" v-model="formatDetails.q3_driver_count"
                   required>
        </div>
    </div>
    ...
    <div class="row mb-3">
        <div class="col-4">
            ...
            <input type="number" id="runs_per_session" class="form-control" v-model="formatDetails.runs_per_session"
                   required>
        </div>
