<template>
    ...
    <p>
        Series are also where engines are stored, however they are not required to actually run a sim. As with
        <InertiaLink :href="route('tutorials', 'teams')">teams</InertiaLink>
        and
