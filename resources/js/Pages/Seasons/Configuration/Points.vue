<template>
  ...
  <form @submit.prevent="form.post(route('seasons.configuration.points.store', [season]))">
    ...
    <div class="mb-3 w-25">
      ...
      <input type="number" id="amount_of_point_scorers" v-model="amountOfPointScorers" class="form-control" @change="setPointScorerInputs" required>
    </div>
    ...
    <div class="row">
      <div class="col-6">
        ...
        <div class="col-6 mb-3 input-group" v-for="(point, key) in form.points" :key="key">
          ...
          <input type="text" class="form-control" v-model="point.points">
        </div>
      </div>
      ...
      <div class="col-6">
        ...
        <div class="row mb-3">
          <div>
            <input type="checkbox" class="form-check-input me-1" v-model="form.fastest_lap_point_awarded" id="point_for_fastest_lap">
          ...
          <div v-if="form.fastest_lap_point_awarded">
            <div class="my-3">
              ...
              <input type="number" class="form-control" v-model="form.fastest_lap_point_amount" :required="form.fastest_lap_point_awarded">
            </div>

            <div class="my-3">
              <label for="fastestLapDetermination" class="form-label">Fastest lap determination</label>
              <select id="fastestLapDetermination" class="form-control" v-model="form.fastest_lap_determination" :required="form.fastest_lap_point_awarded">
            ...
            <div class="row" v-if="fastestLapIsSeparateStint">
              <div class="col-6">
                ...
                <input type="number" class="form-control" v-model="form.fastest_lap_min_rng" :required="fastestLapIsSeparateStint">
              </div>

              <div class="col-6">
                <label for="fastest_lap_max_rng" class="form-label">Fastest lap max RNG</label>
                <input type="number" class="form-control" v-model="form.fastest_lap_max_rng" :required="fastestLapIsSeparateStint">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row mb-3">
          <div>
            <input type="checkbox" class="form-check-input me-1" v-model="form.pole_position_point_awarded" id="point_for_pole_position">
          ...
          <div v-if="form.pole_position_point_awarded">
            <div class="my-3">
              <label for="amount_of_points_for_pole" class="form-label">Amount of points for pole position</label>
              <input type="number" class="form-control" v-model="form.pole_position_point_amount" :required="form.pole_position_point_awarded">
            </div>
          </div>
        </div>
      </div>
